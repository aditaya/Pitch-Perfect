...
//  Pitch Perfect
//
//  Created by Vineet Mahali on 02/08/20.
...
extension PlaySoundViewController: AVAudioPlayerDelegate {
    ...
    struct Alerts {
        ...
        static let RecordingDisabledMessage = "You've disabled this app from recording you microphone. Check Settings."
    ...
    func playSound(rate: Float? = nil, pitch: Float? = nil, echo: Bool = false, reverb: Bool = false) {
        ...
        do {
            ...
            showAlert(Alerts.AudioEngineError, messages: String(describing: error))
        }
    ...
    func showAlert(_ title: String, messages: String)  {
